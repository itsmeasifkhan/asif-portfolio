    ...
    <section id="contact" className="py-28 relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center">
        ...
        <p className="text-white/40 text-lg max-w-xl mx-auto mb-12">
          I'm open to Flutter developer roles and exciting mobile app projects. Let's make it happen.
        </p>
        ...
        <div className="flex items-center justify-center gap-6 mb-16">
          <a
            href="https://www.linkedin.com/in/mohmmad-asif"
            target="_blank"
          ...
          <span className="text-white/20 text-sm">Gurugram, Haryana</span>
        </div>
